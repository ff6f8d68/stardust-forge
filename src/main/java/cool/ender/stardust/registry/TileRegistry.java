...
public class TileRegistry {
    ...
    public static final RegistryObject<BlockEntityType<Tube.Tile>> TUBE_TILE = TILES.register(new Tube().getRegisterName(), () -> BlockEntityType.Builder.of(Tube.Tile::new, BlockRegistry.TUBE_BLOCK.get()).build(null));
}
